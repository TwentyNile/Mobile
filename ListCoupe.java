...
public class ListCoupe extends AppCompatActivity implements AdapterView.OnItemClickListener{
        ...
        setContentView(R.layout.activity_list_coupe);


        String url = "http://10.0.2.2:3000/detail1";
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Intent itn = new Intent(this,DetailCoupeActivity.class);
