...
public class ListSport extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://10.0.2.2:3000/fluke";
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Intent itn = new Intent(this,DetailSportActivity.class);
